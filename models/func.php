<?php
    //func.php работает напрямую с базой данных//////////////////////////////////////////
...
*/
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    //добавляет новое видео обрезает первые 17 символов///////////////////////////////////
    function video_add($link, $video, $datetim, $timezone)
    {
        ...
        //Проверка: если $video пустое значение ИЛИ значение $tube НЕ равно первым 18символам $video
